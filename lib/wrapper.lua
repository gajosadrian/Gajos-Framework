...
function sv_map(map) -- error map() -> sv_map()
    parse('map '..map)
end
...
function mp_flashlight(flashlights)
    parse('mp_flashlight '..flashlights)
end
...
function mp_hud(elements)
    parse('mp_hud '..elements)
end

function mp_hudscale(scale)
    parse('mp_hudscale '..scale)
end
...
function sv_soundpos(soundfile,x,y,id)
    parse('sv_soundpos "'..soundfile..'" '..x..' '..y..' '..id)
end
